...
public class ItemArtilleryShells extends Item {
	...
	public ItemArtilleryShells(int par1) {
		super(par1);
		setMaxDamage(0);
		setHasSubtypes(true);
	}
	...
	public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
		SAP_LanguageManager langman = (TM3ModRegistry.manHelper.getLangMan());
		switch(par1ItemStack.getItemDamage()) {
			case 1: case 6:
			case 3: case 8:
				par3List.add(langman.getTranslated("turretmod3.item.artilleryInfo").split("\\|")[0] + ": 4");
				break;
			case 0: case 5:
			case 2: case 7:
				par3List.add(langman.getTranslated("turretmod3.item.artilleryInfo").split("\\|")[0] + ": 2");
				break;
			case 4: case 9:
				par3List.add(langman.getTranslated("turretmod3.item.artilleryInfo").split("\\|")[0] + ": 2");
				par3List.add(langman.getTranslated("turretmod3.item.artilleryInfo").split("\\|")[2]);
				break;
		}
		switch(par1ItemStack.getItemDamage()) {
			case 2: case 3:
